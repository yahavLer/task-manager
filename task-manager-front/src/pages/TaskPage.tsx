      ...
      <div style={{ marginTop: 20 }}>
        {state.filteredTasks.map((t) => (
          <TaskCard
            ...
            editUserQuery={state.editUserQuery}
            editUserOptions={state.editUserOptions}
            onEditQueryChange={state.onEditQueryChange}
            onEditUserSelect={state.onEditUserSelect}
          />
        ))}
      </div>
    </div>
